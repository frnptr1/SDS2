...
ggplot(data = data.frame(x = c(-5, 5)), aes(x)) + 
  theme_bw() + 
  theme(plot.title = element_text(size = 15), text = element_text(size=15))+
  stat_function(fun = ns_t, args = list(mu=0, tau = 1, k = 3), size = 0.5, aes(colour = "Model1")) + 
  stat_function(fun = dnorm, args = list(mean = 0, sd = 1), size = 0.5, aes(colour = "Model2"))+
  xlim(-5,5)+
